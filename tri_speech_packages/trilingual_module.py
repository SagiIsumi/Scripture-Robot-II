...
def minnan_speak2(sentence, accent=0, gender=1, volume=1.0):
    ...
    gender_args = ['男聲','女聲']
    text1 = requests.get(f'http://tts001.iptcloud.net:8804/html_taigi_zh_tw_py?text0={sentence}').content.decode() 
    # translate to TLPA (Taiwan Language Phonetic Alphabet)    
